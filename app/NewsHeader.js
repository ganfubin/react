...
export default class NewsHeader extends React.Component {
	...
	getLogo() {
		return ( < div className = "newsHeader-logo" >
			< a href = "https://baidu.com" > < img src = {
				imageLogo
			}
			/></a >
			< /div>
	...
	getTitle() {
		return ( < div className = "newsHeader-title" >
			...
			href = "https://news.ycombinator.com/" > 黑客新闻 < /a> < /div>
		);
	}
	getNav() {
		var navLinks = [{
		...
		return ( < div className = "newsHeader-nav" > {
			navLinks.map(function(navLink) {
				return ( < a key = {
					...
					href = {
						"https://news.ycombinator.com/" + navLink.url
					} > {
						navLink.name
					} < /a>
				);
	...
	getLogin() {
		return ( < div className = "newsHeader-login" >
			< a className = "newsHeader-textLink"
			href = "https://news.ycombinator.com/login?goto=news" > login < /a> < /div>
		);
	}
